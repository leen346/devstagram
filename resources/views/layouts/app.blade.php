...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        @stack('styles')        {{-- stack styles nos permite reservar este espacio para poder agregar hojas de estilos que sean diferentes, que no se requieran  en todas
            tus vistas--}}
        {{--  @stack('scripts') tiene la misma funcionalidad de styles --}}
            ...
            <div class="container mx-auto flex justify-between items-center">
                ...
                @auth
                    ...
                    <nav class="flex gap-2 items-center">
                        ...
                        <a class="font-bold  text-gray-600" href="{{route('posts.index', auth()->user()->username)}}">Hola: <span class="font-normal">{{auth()->user()->username}}</span></a>
